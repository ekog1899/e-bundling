...
class Monitoring extends CI_Controller {
	...
	public function belum_register(){
        $data_content['data_mon'] = $this->monitoring->banding_belum_register(date('Y'));
        $data['title'] = "Monitoring Banding Belum Register";
        // $data_content['tahun'] = date('Y');
        $data['content'] = $this->load->view("v_belum_register",$data_content,true); 
        $this->load->view("template",$data);
    }

    public function belum_ada_pemeriksa(){
        $data_content['data_mon'] = $this->monitoring->belum_ada_tim_pemeriksa(date('Y'));
        $data['title'] = "Monitoring Belum Ada Tim Pemeriksa Pra Daftar";
        // $data_content['tahun'] = date('Y');
        $data['content'] = $this->load->view("v_belum_ada_tim_pemeriksa",$data_content,true); 
        $this->load->view("template",$data);
    }

    public function perkara_banding_putus(){
        $data_content['data_banding_putus'] = $this->monitoring->perkara_ban_putus();
        $data['title'] = "Monitoring Data Perkara Banding Yang Sudah Putus";
