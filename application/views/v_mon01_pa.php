...
<div class="form-group row">
    ...
    <div class="col-sm-10">
	<form method="POST" action="<?php echo site_url('main/kasasi_satker');?>">
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		if (empty($data_mon)) {
			...
			<td><a href='<?php echo site_url('main/kasasi_satker/'.$tahun.'/banding/'.$b['satsing']);?>'><?php echo $b['banding'];?></a></td>
			<td><a href='<?php echo site_url('main/kasasi_satker/'.$tahun.'/kasasi_skrg/'.$b['satsing']);?>'><?php echo $b['kasasi_skrg'];?></a></td>
			<td><a href='<?php echo site_url('main/kasasi_satker/'.$tahun.'/kasasi_depan/'.$b['satsing']);?>'><?php echo $b['kasasi_depan'];?></a></td>
		...
		<?php
			...
			?>
			<td colspan=2>JUMLAH (<?php echo $j_banding1+$j_kasasi1+$j_banding2;?>)</td>
