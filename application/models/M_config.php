<?php
	...
	class M_config extends CI_Model
	{
		...
		function reload_satker($id_satker_pta){
			...
			$this->db->query('truncate table satker');
			$sql = "insert into satker SELECT id_satker_sipp,nama_satker,id_satker_sipp,'0','0','null', id_satker_dipa01 FROM master_satker WHERE id_parent_sipp='".$id_satker_pta."'";
			$this->db->query($sql);
		}
		...
		function get_user_wakil(){
			$this->db->where('kode_jabatan',2);
			return $this->db->get('t_user_pta')->row()->nama;
