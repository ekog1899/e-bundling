...
<div class="well">
<form action="<?php echo base_URL()?>config/passwd/simpan" method="post" accept-charset="utf-8" enctype="multipart/form-data">

	<table class="table-form" width="100%">
	<tr><td width="20%">Username</td><td><b><input type="text" name="username" class="form-control" readonly value="<?=$this->session->userdata('user_username')?>" style="width: 200px"></b></td></tr>
